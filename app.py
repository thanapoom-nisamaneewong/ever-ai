...
from apps import diabetes, hypertension, hyperlipidaemia,predictivehealthapp,healthpredictionapp,diseasepredictionapp,drugapp,home,outbreakforcastingapp,pakinsondrawingsapp,druginterctionapp,ocr,xray,sleep,healthsummary,patho,covid,ekyc,map,speeh
